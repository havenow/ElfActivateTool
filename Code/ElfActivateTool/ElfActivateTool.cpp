...
// ElfActivateTool.cpp : 定义应用程序的类行为。
//
...
BEGIN_MESSAGE_MAP(CElfActivateToolApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CElfActivateToolApp 构造

CElfActivateToolApp::CElfActivateToolApp()
{
	// 支持重新启动管理器
...
BOOL CElfActivateToolApp::InitInstance()
{
	...
	AfxInitRichEdit2();//使用CRichEditCtrl，需要调用
